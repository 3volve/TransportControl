...
class AirFactory implements TransportFactory {
	...
	static TransportLine createTransportLine( String name, HashMap<String, TransportLine> airlines ) {
		...
		if( SystemTester.systemCreateTest(errorStr, conditions, "duplicate name.", "incorrect airlines naming syntax.") )
	...
	static Transition createTransition( Transition.DataClass data ) {
		...
		if( SystemTester.systemCreateTest(BaseErrorStr, conditions, "same airport at origin and destination.", "no airline named " + data.lName + ".",
	...
	static TransportSection createSection( AirSection.DataClass data ) {
		...
		if( SystemTester.systemCreateTest(BaseErrorStr, conditions, "incorrect # of rows.", " no airline named " + data.airline + ".", "duplicate SeatClass."))
